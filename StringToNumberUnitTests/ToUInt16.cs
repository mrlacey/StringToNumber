...
namespace StringToNumberUnitTests
{
    ...
    public class ToUInt16
    {
        ...
        [Test, ExpectedException(typeof(OverflowException), ExpectedMessage = "Value was either too large or too small for a UInt16.")]
        public void MinusOne_IsNotValid()
        {
            Assert.That(this.np.ToUInt16("minus one"), Is.EqualTo(-1));
        }
        ...
        {
            Assert.That(this.np.ToUInt16("minus zero"), Is.EqualTo(-0));
        }
        ...
        {
            Assert.That(this.np.ToUInt16("sixty five thousand five hundred and thirty six"), Is.EqualTo(65536));
        }
    }
}
